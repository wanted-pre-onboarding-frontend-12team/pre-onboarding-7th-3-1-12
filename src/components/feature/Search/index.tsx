...
const Search = () => {
	const { keyword, debouncedKeyword, cacheData, setCacheData, onChangeKeyword, resetKeyword } = useSearch();
	const { keyHandler } = useKeyControl();
	...
	return (
		<SearchContainer>
			...
			{keyword && <AutoSearch keyword={debouncedKeyword} cacheData={cacheData} setCacheData={setCacheData} />}
		</SearchContainer>
	);
};
